...
|---|---|---|---|
| Initiative | A prioritized business ask; the unit that enters the pipeline. One business brief, one product definition. | `initiative` | See [`../thinking/front-of-flow.md`](../thinking/front-of-flow.md) |
...
| Level tag | Marker on a requirement: L1 to L4. How precise it is, and which persona's language. | — | See [`../thinking/front-of-flow.md`](../thinking/front-of-flow.md) |
