...
**Pipeline step:** 11. Provisioning & Enablement · [← back to master](../sdlc-business-process-flow.md)
...
- **Receives from:** [Merge & Release Approval Gate](10-merge-release-approval-gate.md) (step 10).
- **Delivers to:** [Deployment Agent](12-deployment-agent.md) (step 12) once infra is ready; or to the human-fulfilled enabler queue for novel requests, with an async signal back to the pipeline on completion.
