...
**Pipeline step:** 13. Post-Release Validation & Monitoring · [← back to master](../sdlc-business-process-flow.md)
...
- **Receives from:** [Deployment Agent](12-deployment-agent.md) (step 12).
