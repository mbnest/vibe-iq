...
This directly resolves the "what is the first feature" prerequisite named in [`vibe-engineering-platform-notes.md`](../vibe-engineering-platform-notes.md)'s Open questions: rather than dogfooding the Intake Agent's own implementation, this hand-simulates the front-of-flow chain against a real ask.
