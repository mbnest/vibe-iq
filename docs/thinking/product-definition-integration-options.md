...
Companion to [`front-of-flow.md`](front-of-flow.md), [`agents/definition-agent.md`](agents/definition-agent.md), and [`product-definition-phase-open-questions.md`](product-definition-phase-open-questions.md). Consistent with how the platform already treats external systems — the backlog as an "integration seam" ([architecture-napkin.md](architecture-napkin.md)), the Project Twin as "not the system of record" ([project-twin.md](project-twin.md)), n8n as "glue, never the core" ([platform-runtime.md](platform-runtime.md)).
