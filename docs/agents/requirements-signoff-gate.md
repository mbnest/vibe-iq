...
**Role:** Requirements Sign-off · [pipeline order](README.md) · [master diagram](../architecture/process-flow.md)
...
- **Receives from:** [Intake Agent](intake-agent.md) — `spec.md`.
- **Delivers to:** [Design Agent](design-agent.md), on approval.
