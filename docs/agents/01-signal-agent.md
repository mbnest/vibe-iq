...
**Pipeline step:** 1. Opportunity Identification · [← back to master](../sdlc-business-process-flow.md)
...
- **Delivers to:** [Scoping Agent](02-scoping-agent.md) (step 2), which evaluates whether and how to act on the opportunity.
