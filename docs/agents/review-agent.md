...
**Role:** Review · [pipeline order](README.md) · [master diagram](../architecture/process-flow.md)
...
- **Receives from:** [Test Agent](test-agent.md).
- **Delivers to:** [Merge & Release Approval Gate](merge-release-approval-gate.md).
