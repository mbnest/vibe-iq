...
**Role:** Planning / Breakdown · [pipeline order](README.md) · [master diagram](../architecture/process-flow.md)
...
- **Receives from:** [Design Agent](design-agent.md).
- **Delivers to:** [Implementation Agent(s)](implementation-agent.md), per task-graph node.
