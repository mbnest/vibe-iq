...
**Role:** Deployment / Go-Live · [pipeline order](README.md) · [master diagram](../architecture/process-flow.md)
...
- **Receives from:** [Enablement Agent](enablement-agent.md).
- **Delivers to:** [Validation Agent](validation-agent.md).
