...
**Pipeline step:** 7. Implementation · [← back to master](../sdlc-business-process-flow.md)
...
- **Receives from:** [Planning Agent](06-planning-agent.md) (step 6).
- **Delivers to:** [Test Agent](08-test-agent.md) (step 8) and [Review Agent](09-review-agent.md) (step 9).
