...
Companion to [`front-of-flow.md`](../architecture/front-of-flow.md) and the (proposed) Definition Agent. The phase produces artifact #2 (L2 product definition) from artifact #1 (L1 business brief / intake request).
...
- **B.** Back to Scoping for more work before re-entering.
