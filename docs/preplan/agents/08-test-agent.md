...
**Pipeline step:** 8. Testing · [← back to master](../sdlc-business-process-flow.md)
...
- **Receives from:** [Implementation Agent(s)](07-implementation-agent.md) (step 7).
- **Delivers to:** [Review Agent](09-review-agent.md) (step 9).
